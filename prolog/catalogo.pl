...
musica("Levels", "Avicii", "Levels", "Eletronica", 227).
musica("Lean On", "Major Lazer", "Peace Is the Mission", "Eletronica", 176).
musica("Clarity", "Zedd", "Clarity", "Eletronica", 257).
musica("Don't You Worry Child", "Swedish House Mafia", "Until Now", "Eletronica", 210).
...
musica("Olha pro Céu", "Luiz Gonzaga", "Luiz Gonzaga", "Forro", 210).
...
musica("Parado no Bailão", "MC L da Vinte", "Parado no Bailão", "Funk", 210).
musica("Bum Bum Tam Tam", "MC Fioti", "Bum Bum Tam Tam", "Funk", 230).
musica("Deu Onda", "MC G15", "Deu Onda", "Funk", 190).
musica("Tô Querendo", "MC Kekel", "Tô Querendo", "Funk", 215).
...
musica("Dog Days Are Over", "Florence + The Machine", "Lungs", "Indie", 230).
musica("Electric Feel", "MGMT", "Oracular Spectacular", "Indie", 230).
musica("Sex on Fire", "Kings of Leon", "Only by the Night", "Indie", 220).
musica("Kids", "MGMT", "Oracular Spectacular", "Indie", 265).
...
musica("Roda Viva", "Chico Buarque", "Roda Viva", "MPB", 200).
...
musica("Ainda Gosto de Você", "Só Pra Contrariar", "Só Pra Contrariar", "Pagode", 220).
musica("Faz Um Milagre em Mim", "Jeito Moleque", "Jeito Moleque", "Pagode", 230).
musica("Que Nem Maré", "Thiaguinho", "Acústico", "Pagode", 215).
musica("Te Amo", "Raça Negra", "Raça Negra", "Pagode", 240).
...
musica("Firework", "Katy Perry", "Teenage Dream", "Pop", 228).
musica("Call Me Maybe", "Carly Rae Jepsen", "Kiss", "Pop", 193).
musica("Roar", "Katy Perry", "Prism", "Pop", 222).
...
musica("Stairway to Heaven", "Led Zeppelin", "Led Zeppelin IV", "Rock", 482).
musica("Wonderwall", "Oasis", "(What's the Story) Morning Glory?", "Rock", 258).
...
musica("Romaria", "Renato Teixeira", "Romaria", "Sertanejo", 210).
musica("Pra Sempre Vou Te Amar", "Jorge & Mateus", "Pra Sempre Vou Te Amar", "Sertanejo", 255).
musica("Meu Coração Deu PT", "Gusttavo Lima", "Meu Coração Deu PT", "Sertanejo", 220).
musica("Camaro Amarelo", "Munhoz & Mariano", "Camaro Amarelo", "Sertanejo", 205).
